...
[![smithery badge](https://smithery.ai/badge/@smithery/mcp-flowise)](https://smithery.ai/server/@smithery/mcp-flowise)
...
To install mcp-flowise for Claude Desktop automatically via [Smithery](https://smithery.ai/server/@smithery/mcp-flowise):

```bash
npx -y @smithery/cli install @smithery/mcp-flowise --client claude
```
